      ...
      <div class="tree-body">
        <table v-if='treeDataSource.length>0'>
          <tbody>
            <tr>
              <td>
                <tree-item v-for="(model,i) in treeDataSource" :key="'root_node_'+i" :root="0" :num="i"
                  @actionFunc="actionFunc" @deleteFunc="deleteFunc" @handlerExpand="handlerExpand"
                  :nodes="treeDataSource.length" :trees.sync="treeDataSource" :model.sync="model">
                </tree-item>
              </td>
            </tr>
          </tbody>
...
export default {
  ...
  methods: {
    ...
    // end = percent
    // if (percent < 40) {
    //   return 'background: linear-gradient(80deg, #00FA9A ' + start + '%, ' + initialColor + ' ' + end + '%)';
    // } else if (percent < 80) {
    //   return 'background: linear-gradient(80deg, #00FA9A ' + start + '%, ' + interimClolor + ' ' + end + '%)';
    // } else if (percent < 90) {
    //   return 'background: linear-gradient(80deg, #00FA9A ' + start + '%, ' + finally1 + ' ' + end + '%)';
    // }
